package com.caixc.mallchat.common.user.controller;
...
public class WxPortalController {
    ...
    @GetMapping("/test")
    public String getQrcodeUrl (String ticket) throws WxErrorException {
        String qrcodeUrl = wxService.getQrcodeService().qrCodeCreateTmpTicket(ticket,2592000).getUrl();
        return qrcodeUrl;
    }
